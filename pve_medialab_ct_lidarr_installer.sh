#!/usr/bin/env bash
# ----------------------------------------------------------------------------------
# Filename:     pve_medialab_ct_lidarr_installer.sh
# Description:  Installer script for Proxmox Lidarr Server
# ----------------------------------------------------------------------------------
...
#---- Source local Git
# /mnt/pve/nas-01-git/ishanjain28/pve-medialab/pve_medialab_ct_lidarr_installer.sh
...
GIT_APP_SCRIPT='pve_medialab_ct_lidarr.sh'
