...
# Description:  Installer script for Proxmox Deluge Server
# ----------------------------------------------------------------------------------
...
#---- Source local Git
# /mnt/pve/nas-01-git/ishanjain28/pve-medialab/pve_medialab_ct_deluge_installer.sh
...
GIT_APP_SCRIPT='pve_medialab_ct_deluge.sh'
