...
# Description:  Installer script for Proxmox Radarr Server
# ----------------------------------------------------------------------------------
...
#---- Source local Git
# /mnt/pve/nas-01-git/ishanjain28/pve-medialab/pve_medialab_ct_radarr_installer.sh
...
GIT_APP_SCRIPT='pve_medialab_ct_radarr.sh'
