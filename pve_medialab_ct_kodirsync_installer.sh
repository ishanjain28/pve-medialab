...
#---- Source Github
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/ishanjain28/pve-medialab/master/pve_medialab_ct_kodirsync_installer.sh)"

#---- Source local Git
# /mnt/pve/nas-01-git/ishanjain28/pve-medialab/pve_medialab_ct_kodirsync_installer.sh
